...
namespace Kalan.Core.Diagnostics;

/// <summary>
/// Kalan'ın kalıcı, gizlilik-korumalı günlük yazıcısı.
///
    ...
    public static string LogPath
    {
        get
        {
            ...
            return string.IsNullOrWhiteSpace(localAppData)
                ? Path.Combine(AppContext.BaseDirectory, "kalan.log")
                : Path.Combine(localAppData, "Kalan", "kalan.log");
        }
    }
