...
/// <summary>
/// Aynı Windows kullanıcısının Kalan örneklerini tek mutex altında toplar.
...
{
    private const string WakeMessageName = "Kalan.SingleInstance.Wake.v1";
